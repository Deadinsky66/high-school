...
* Software that will play a rock-paper-scissors-spock-lizard game with the computer to 10.
* Thomas Dedinsky
* 08/04/2016
*/
class RockPaperScissorsSpockLizard
{
    /*Description - int method that asks the user a rock/paper/scissors/spock/lizard question
     Pre - N/A
     Post - Returns a 1/2/3/4/5 response
    */
    public static int userInput()
    {
        ...
        while (confirmation!='R'&&confirmation!='r'&&confirmation!='P'&&confirmation!='p'&&confirmation!='S'&&confirmation!='s'&&confirmation!='Q'&&confirmation!='q'&&confirmation!='L'&&confirmation!='l') {
            System.out.println("Input R, S, P, Q or L.");
            confirmation = In.getChar();
        }
        ...
        else if (confirmation=='S'||confirmation=='s') {userInput=3;}
        else if (confirmation=='Q'||confirmation=='q') {userInput=4;}
        else {userInput=5;}
        return userInput;
    }
    ...
    */
    public static int winner(int userInput)
    {
        ...
        int compInput = (int)Math.ceil(Math.random()*5);
        if (compInput==1) {System.out.println("rock!");}
        else if (compInput==2) {System.out.println("paper!");}
        else if (compInput==3) {System.out.println("scissors!");}
        else if (compInput==4) {System.out.println("spock!");}
        else {System.out.println("lizard!");}
        //I determine if the user won, computer won, or if they tied, and return an int value correlating to that
        if (compInput==1&&userInput==2||compInput==2&&userInput==3||compInput==3&&userInput==4||compInput==4&&userInput==5||compInput==5&&userInput==1||compInput==1&&userInput==4||compInput==2&&userInput==5||compInput==3&&userInput==1||compInput==4&&userInput==2||compInput==5&&userInput==3) {
            System.out.println("You win a match! Congrats!");
            winner=1;
        }
        else if (compInput==2&&userInput==1||compInput==3&&userInput==2||compInput==4&&userInput==3||compInput==5&&userInput==4||compInput==1&&userInput==5||compInput==4&&userInput==1||compInput==5&&userInput==2||compInput==1&&userInput==3||compInput==2&&userInput==4||compInput==3&&userInput==5) {
            System.out.println("You lost a match! Better luck next time!");
            winner=2;
        }
        else {
            System.out.println("You guys tied! Rematch!");
        }
        return winner;
    }
    ...
    public static void main (String args[])
    {
        ...
        System.out.println("Welcome to Rock Paper Scissors Spock Lizard Land (circa 2005). This is a game to 10.");
        System.out.println("R for Rock, S for Scissors, P for Paper, Q for Spock, L for Lizard.");
        ...
        if (userScore==10) {
            System.out.println("You won the whole game! Woot woot!");
        }
        else {
            System.out.println("You lost the whole game! How do you sleep at night man?");
        }
