...
public class TextPanelTypeStefanie
{
    ...
    public static String ghostName = "ghostStefanie.txt";
    ...
    {
        frame = new JFrame("Stefanie - State of the art chat client");
    ...
    public static class ButtonListener implements ActionListener 
    {
        ...
        public void actionPerformed(final ActionEvent ev)
        {
            ...
            if (!input.getText().trim().equals(""))
            {
                ...
                {
                    refresh();
                    output.append("Stefanie: "+input.getText());
                    bufferedWriter.write("Stefanie: "+input.getText());
                    bufferedWriter.newLine();
                    ghostBWriter.write("Stefanie: "+input.getText());
                    ghostBWriter.newLine();
                    output.append("\n");
                    input.setText("");
                }
